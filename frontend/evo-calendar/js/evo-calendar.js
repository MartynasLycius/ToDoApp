...
(function (factory) {
  ...
  EvoCalendar = (function () {
    ...
    function EvoCalendar(element, settings) {
      ...
      _.defaults = {
        ...
        calendarEvents: null,
        onSelectDate:function (clickEvent) {
          console.log("onSelectDate clicked.....");
        }
  ...
  EvoCalendar.prototype.buildCalendar = function () {
    ...
    // set event listener on select each date, call back function
    /*_.$elements.innerEl.find('.calendar-day').children()
        .off('click.evocalendar')
        .on('click.evocalendar', _.options.onSelectDate);*/
    _.$elements.innerEl.find('.calendar-day').each(function () {
      $(this).on('click', _.options.onSelectDate);
    })
  };
