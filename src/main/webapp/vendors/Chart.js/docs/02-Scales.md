...
The linear scale is use to chart numerical data. It can be placed on either the x or y axis. The scatter chart type automatically configures a line chart to use one of these scales for the x axis. As the itemName suggests, linear interpolation is used to determine where a value lies on the axis.
...
The logarithmic scale is use to chart numerical data. It can be placed on either the x or y axis. As the itemName suggests, logarithmic interpolation is used to determine where a value lies on the axis.
